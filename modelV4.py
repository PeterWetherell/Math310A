...
for seg_num in range(num_segments):
    ...
    if (seg_num % num_segments_per_save == 0 and seg_num != 0):
        model.save(f'./Models2/deonoiserV4-{seg_num // num_segments_per_save}-0.keras')
model.save(f'./Models2/deonoiserV4-{seg_num // num_segments_per_save}-{seg_num % num_segments_per_save}.keras')